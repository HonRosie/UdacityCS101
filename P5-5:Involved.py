...
#Loop through each hexamester
#Loop through each course in hexamester you're in
#Loop through each key and check if value equals person
def involved(courses, person):
    involved = {}
    for hexamester in courses:
        for course in courses[hexamester]:
            for info in courses[hexamester][course]:
                if courses[hexamester][course][info] == person:
                    if hexamester not in involved:
